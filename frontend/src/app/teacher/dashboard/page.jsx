...
export default function TeacherDashboardPage() {
  ...
  const inputStyle = useMemo(
    () => ({
      ...
      boxShadow: `0 0 0 1px ${hexToRgba(primaryColor, 0.04)}`,
    }),
    [primaryColor]
  );
              ...
              <section className="mt-8 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
                <div className="rounded-[30px] border border-slate-200 bg-white/88 p-6 shadow-[0_14px_40px_rgba(0,0,0,0.05)] backdrop-blur sm:p-8">
                  ...
                  <div className="mt-8 grid gap-4 sm:grid-cols-3">
                    <StatCard title="Assigned Courses" value={stats.assignedCourses || 0} tint={mutedTint} />
                    <StatCard title="Modules" value={stats.modulesCount || 0} tint={mutedTint} />
                    <StatCard title="Lessons" value={stats.lessonsCount || 0} tint={mutedTint} />
                  </div>
                </div>
